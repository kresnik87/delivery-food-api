...
use KsK\Shared\Domain\Criteria\Filter;
use KsK\Shared\Domain\Criteria\FilterField;
use KsK\Shared\Domain\Criteria\OrderBy;
...
final class DoctrineCriteriaConverter
{
    ...
    private function buildComparison(): callable
    {
        return function (Filter $filter): Comparison {
            ...
            return new Comparison($field, $filter->operator()->getValue(), $value);
        };
    }
